...
net_xauusd = fitnet(hiddenLayerSize,trainFcn);
...
net_xauusd.trainParam.epochs = 60;
% Setup Division of Data for Training, Validation, Testing
% For a list of all data division functions type: help nndivision
net_xauusd.divideFcn = 'dividerand';  % Divide data randomly
net_xauusd.divideMode = 'sample';  % Divide up every sample
...
% Train the Network
[net_xauusd,tr] = train(net_xauusd,x,t);
